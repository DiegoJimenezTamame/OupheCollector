 ...
 * {@link android.graphics.Picture} can only be rendered this way.
 */
public class SvgSoftwareLayerSetter implements RequestListener<PictureDrawable> {

    @Override
    public boolean onLoadFailed(GlideException e, Object model, @NonNull Target<PictureDrawable> target, boolean isFirstResource) {
